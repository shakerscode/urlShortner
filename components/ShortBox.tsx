...
export default function LinkShortener() {
  ...
  return (
    <div className="flex flex-col items-center bg-background-blue min-h-screen py-10 px-4">
      {/* Tab Selection */}
      ...
      <div className="bg-white rounded-[36px] shadow p-6 mt-8 max-w-3xl w-full">
        ...
        <div className="mt-6">
          ...
          />
          {activeTab === "qr" && <p className="text-sm font-normal mt-4 text-red-500">{"QR code is not available right now!"}</p>}
          <button
